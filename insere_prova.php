<?php
		...
		$sqlinsert = "insert into pizzas (sabor, ingredientes, massa, tamanho, calorias, alergenicos, valor)
					  values ('$sabor','$ingredientes', '$massa', '$tamanho', '$calorias', '$alergenicos', '$valor')";
		...
		<body>
		 <div class = 'container'>
      	...
      	<fieldset>";
			echo "<font color= #ff1119>&nbsp &#x1f355 DADOS INSERIDOS NO BANCO COM SUCESSO! &#x1f355</font>";
